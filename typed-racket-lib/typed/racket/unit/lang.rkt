...
;; Implementation of #lang typed/racket/unit
...
(provide (rename-out [module-begin #%module-begin])
         (except-out (all-from-out typed/racket/base) #%module-begin-typed)
         (all-from-out typed/racket/unit))
     ...
     (with-syntax ([((elem ...) . (literal ...))
       ...
       (with-syntax ((name (datum->syntax
         ...
         (datum->syntax
          stx
          (syntax-e
           #'(#%module-begin-typed (a-unit-module orig-stx finish-a-unit (import export) 
